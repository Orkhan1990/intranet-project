...
export const AppDataSource = new DataSource({
    ...
    database:DATABASE,
    entities: [User,Client,Card,CardProblem,CardJob,CardWorkerJob,Supplier,Brand,Invoice,SparePart,Order,OrderPart,OrderHistory,SupplierOrderHistory,SupplierOrderParts,PriceList,PriceListHist],
    synchronize: false,
