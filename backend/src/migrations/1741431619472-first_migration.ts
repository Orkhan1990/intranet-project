...
export class FirstMigration1741431619472 implements MigrationInterface {
    name = 'FirstMigration1741431619472'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`order_parts\` (\`id\` int NOT NULL AUTO_INCREMENT, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`orig_code\` varchar(255) NULL, \`count\` int NULL, \`price\` int NULL, \`total_price\` int NULL, \`transport\` int NULL, \`sip_price\` int NULL, \`unit_sip_price\` int NULL, \`percent\` int NULL, \`profit\` int NULL, \`sell_price\` int NULL, \`unit_sell_price\` int NULL, \`stock_quantity\` int NULL, \`part_name\` varchar(255) NULL, \`orderId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
